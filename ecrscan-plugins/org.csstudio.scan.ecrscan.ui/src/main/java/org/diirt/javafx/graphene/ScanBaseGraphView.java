 ...
 */
abstract public class ScanBaseGraphView< T extends Graph2DRendererUpdate< T > > extends BorderPane {
    ...
    protected void reconnect( String dataFormula ) {
       // synchronized(lock) {
        if (pv != null) {
            System.out.println("close!!!!!"+Objects.toString(pv));
            pv.close();
        ...
        pv = PVManager.read(graph)
                ...
                .readListener(new PVReaderListener<Graph2DResult>() {
                    ...
                    public void pvChanged(PVReaderEvent<Graph2DResult> event) {
                        ...
                        System.out.println("last:"+Objects.toString(pv)+":"+Objects.toString(this)+Objects.toString(event.isValueChanged()));
                        if (pv.getValue() != null) {
                ...
                .maxRate(ofHertz(100));
        System.out.println(Objects.toString(pv));
